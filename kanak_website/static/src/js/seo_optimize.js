odoo.define('kanak_website.seo_optimize', function(require) {
    'use strict';
    ...
    var SeoWebsite = require('website.seo');
    ...
    var Suggestion = Widget.extend({
        ...
        xmlDependencies: ['/kanak_website/static/src/xml/website_seo.xml'],
        events: {
    ...
    var InhSeoConfigurator = Dialog.extend({
        template: 'website.seo_configuration',
        xmlDependencies: Dialog.prototype.xmlDependencies.concat(
            ['/kanak_website/static/src/xml/website_seo.xml']
        ),
        events: {
        ...
        maxTitleSize: 65,
        maxDescriptionSize: 250, // TODO master: remove me and add warning
    ...
    var inhSeoMenu = websiteNavbarData.WebsiteNavbarActionWidget.extend({
        ...
        _promoteCurrentPage: function() {
            new InhSeoConfigurator(this).open();
        },
    });

    websiteNavbarData.websiteNavbarRegistry.add(inhSeoMenu, '#promote-menu');

    SeoWebsite.SeoConfigurator = InhSeoConfigurator;
